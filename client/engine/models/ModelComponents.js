...
{    
    let inverseMatrix =  matrixWorld.clone();
    inverseMatrix.invert();

    let normMatrix =  inverseMatrix.clone();
    normMatrix.transpose();

    const uniform = new Float32Array(16*3);
    for (let i=0; i<16; i++)
    {
    ...
    for (let i=0; i<16; i++)
    {
        uniform[32+i] = inverseMatrix.elements[i];
    }
...
export class Mesh
{
    constructor()
    {
        ...
        this.constant = engine_ctx.createBuffer0(192, GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST);
    }
